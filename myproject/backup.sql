...
--
-- Name: user_saveddefinition; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.user_saveddefinition (
    id bigint NOT NULL,
...
ALTER TABLE public.user_saveddefinition OWNER TO postgres;

--
-- Name: user_saveddefinition_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.user_saveddefinition ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.user_saveddefinition_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
25	Can add saved definition	7	add_saveddefinition
26	Can change saved definition	7	change_saveddefinition
27	Can delete saved definition	7	delete_saveddefinition
28	Can view saved definition	7	view_saveddefinition
\.
...
22	user	0004_saveddefinition	2023-08-15 18:47:20.023435-07
\.
...
35	pbkdf2_sha256$600000$oI5FY9EPSPfvG17QiJGISR$FncAsxAmzgZLwseeL092OQFeBBV1pltVm2WBJK6/HW4=	\N	f	neo@gmail.com	t	f	I love the mechanics behind cars (particularly race cars).	neo
\.
...
--
-- Data for Name: user_saveddefinition; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.user_saveddefinition (id, topic, definition, "timestamp", user_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.user_customuser_id_seq', 35, true);
...
--
-- Name: user_saveddefinition_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.user_saveddefinition_id_seq', 1, false);
...
--
-- Name: user_saveddefinition user_saveddefinition_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_saveddefinition
    ADD CONSTRAINT user_saveddefinition_pkey PRIMARY KEY (id);


--
-- Name: user_saveddefinition user_saveddefinition_user_id_topic_definition_6a73b24b_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_saveddefinition
    ADD CONSTRAINT user_saveddefinition_user_id_topic_definition_6a73b24b_uniq UNIQUE (user_id, topic, definition);
...
--
-- Name: user_saveddefinition_user_id_fb6ddb9e; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX user_saveddefinition_user_id_fb6ddb9e ON public.user_saveddefinition USING btree (user_id);
...
--
-- Name: user_saveddefinition user_saveddefinition_user_id_fb6ddb9e_fk_user_customuser_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_saveddefinition
    ADD CONSTRAINT user_saveddefinition_user_id_fb6ddb9e_fk_user_customuser_id FOREIGN KEY (user_id) REFERENCES public.user_customuser(id) DEFERRABLE INITIALLY DEFERRED;
